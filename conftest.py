...
# 1. Ajouter le répertoire racine au chemin
# d'import pour que pytest trouve server.py
...
# 3. (Optionnel) Si tu veux charger des données de test ou initialiser
#  certaines choses avant les tests
